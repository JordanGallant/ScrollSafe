...
export declare namespace SecretStore {
...
export interface SecretStoreInterface extends utils.Interface {
  functions: {
...
export interface SecretStore extends BaseContract {
  ...
  functions: {
    ...
    ): Promise<[SecretStore.SecretStructOutput[]]>;
